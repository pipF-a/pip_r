...
export const TodosGuest = () => {
    return(
      <>
        <section className="col-span-2 row-span-2 col-start-3 row-start-1 shadow-[var(--custom-shadow)] rounded-md p-4 overflow-auto bg-white grid place-content-center place-items-center">
          <div>
            <hgroup>
